    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Welcome back! Manage your deliveries and track your earnings</p>
        </div>
          ...
          <CardContent>
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-end">
                <Button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white h-12">
                  Save Hours
                </Button>
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="border-2 hover:shadow-lg transition-all">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-2xl font-bold text-purple-600">${stats.thisWeekEarnings.toFixed(2)}</p>
          </CardContent>
        </Card>
        <Card className="border-2 hover:shadow-lg transition-all">
          <CardContent className="p-4 text-center">
            ...
            <CardHeader className="border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  className="px-3 py-2 rounded-lg border-2 border-gray-200 bg-white text-sm font-medium focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
                >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-600">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-bold text-emerald-600">${delivery.estimatedEarnings}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between pt-3 border-t">
                      ...
                      <div className="flex gap-2">
                        {delivery.status === "available" && (
                          <Button
                            className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white"
        ...
        <div className="space-y-6">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="text-center p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border-2 border-emerald-200">
                  ...
                  <p className="text-3xl font-bold text-emerald-600">$95.50</p>
                ...
                <Button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white" asChild>
            ...
            <CardContent className="p-0">
              ...
              <div className="p-4 border-t">
                <Button variant="outline" className="w-full" asChild>
                  <Link href="/courier/reviews">View All Reviews</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 shadow-lg">
            ...
            <CardContent className="p-6 space-y-3">
              ...
              <Button variant="outline" className="w-full justify-start gap-2 border-2 h-12" asChild>
                <Link href="/courier/documents">
                  <Award className="w-4 h-4" />
                  Documents
                </Link>
              </Button>
              <Button variant="outline" className="w-full justify-start gap-2 border-2 h-12" asChild>
                <Link href="/courier/help">
